<div class="task-card flex-grow margin-right bg-white rounded-lg shadow-md relative border-2 border-black p-4 pr-6 m-2" x-data="{ isEditing: false, showConfirm: false }">
    ...
    <div class="flex items-center mt-2">
        ...
        <button @click="showConfirm = true" class="del p-2 text-red-500 hover:bg-black">❌</button>
