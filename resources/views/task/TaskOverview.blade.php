                ...
                <div class="folder-card">
                    ...
                    <div class="task-due-date">
                        @if ($task->due_date)
                            <p>
                                Date limite :
                                <span class="bold">{{ $task->due_date }}</span>
                            </p>
                        @endif
                    </div>
                        ...
                        >
                            ...
                            <div class="form-group">
                                ...
                                >
                                    ...
                                    <option
                                        @if($exist &&$exist->priority == "Urgence") selected @endif
                                        value="Urgence"
                                    >
                                        Urgence
                                    </option>
                                    <option
                                        @if($exist && $exist->priority == "Grande priorité") selected @endif
                                        value="Grande priorité"
                                    >
                                        Grande priorité
                                    </option>
                                    <option
                                        @if($exist && $exist->priority == "Prioritaire") selected @endif
                                        value="Prioritaire"
                                    >
                                        Prioritaire
                                    </option>
